...
def init_db():
    ...
    # BẢNG MỚI: lưu ai đã like bài viết nào
    cursor.execute("""
    ...
    # Fix database cũ: thêm cột nếu thiếu
...
class SocialChatApp:
    def __init__(self, root):
        ...
        # Màu nền pastel chính
        self.root.configure(bg="#F2E8CF")  # pastel vàng nhạt
    ...
    def handle_logout_clear(self):
        ...
        self.show_login_screen()
        # Đảm bảo ô nhập trống sau khi đăng xuất (vấn đề #10)
    ...
    def change_avatar(self):
        """Thay đổi avatar cho tài khoản hiện tại (#7)"""
    ...
    def handle_add_friend(self):
        ...
        # Hiển thị thông tin người dùng trước khi kết bạn (#6)
    ...
    def show_likers(self, post_id, likes_count):
        """Hiển thị cửa sổ danh sách người đã like"""
    ...
    def render_post_item(self, post_id, author_phone, author, content, img_path, mask_enabled, likes, time_str, author_avatar):
        ...
        # Nút like có thể click để xem ai đã like
        like_label = tk.Label(
            stats_frame,
    ...
    def render_comments(self, parent, post_id):
        ...
        cmt_box = tk.Frame(parent, bg="#F7F2E6", padx=8, pady=6)
    ...
    def like_post(self, post_id):
        """Like bài viết: kiểm tra đã like chưa, nếu chưa thì thêm và tăng like"""
        conn = sqlite3.connect(DB_NAME)
        cursor = conn.cursor()
